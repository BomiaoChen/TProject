...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "veGqWoP2xuB55JThoDqrEimoRw4jFPPJ";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			keyword = java.net.URLEncoder.encode(keyword, "UTF-8"); //"Bomiao Chen" to "Bomiao%20Chen"
		...
		try {
			...
			//Tell what HTTP method to use: GET
